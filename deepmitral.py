...
class DeepMitral:
    ...
    model_defs = dict(
        ...
        effnetb0 = FlexibleUNet(1, 2, 'efficientnet-b0', spatial_dims=3, upsample='deconv').to(device),
        effnetb2 = FlexibleUNet(1, 2, 'efficientnet-b2', spatial_dims=3, upsample='deconv').to(device),
        effnetb4 = FlexibleUNet(1, 2, 'efficientnet-b4', spatial_dims=3, upsample='deconv').to(device),
